...
class Solution:
    ...
    def maxProfit(self, prices: list[int], k: int) -> int:
        ...
        dp = [[[None for i3 in range(k+1)] for i2 in range(2)] for i1 in range(n)]
...
sol = Solution();
print(sol.maxProfit([3,3,5,0,0,3,1,4], 4));
print(sol.maxProfit([1,2,3,4,5], 3));
print(sol.maxProfit([1, 2], 2));